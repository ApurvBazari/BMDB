...
var MovieCard = function (_React$Component) {
  ...
  function MovieCard(props) {
    ...
    _this.handleDisike = function () {
      ...
      console.log('handleDislike()->', _this.props);
